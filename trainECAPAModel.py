...
parser.add_argument('--train_list', type=str,   default="/kaggle/working/ACANET/train_list.txt",     help='The path of the training list')
...
parser.add_argument('--eval_list',  type=str,   default="/kaggle/working/ACANET/eval_list.txt",              help='The path of the evaluation list')
...
parser.add_argument('--save_path',  type=str,   default="/kaggle/working/ACANET/exps/exp1",                                     help='Path to save the score.txt and models')
